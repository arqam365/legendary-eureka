...
export default function SoundToggle() {
    ...
    useEffect(() => {
        ...
        try {
            if (enabled && !prefersReduced) {
                // user-initiated play; may still be blocked in rare cases
    ...
    return (
      ...
      "
        >
            {/* Mobile: icon-only circular (≥44px), Desktop: regular labeled button */}
          ...
          "
            ...
            <div className="hidden sm:block">
                <Button
                    ...
                    title={label}
                    className="
            backdrop-blur-md bg-white/70 border-white/60 shadow-sm
            px-3.5 py-2
          "
                >
